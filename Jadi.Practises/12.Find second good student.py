...
print("Second high score student is %s with score %.1f." %(shsn,shs))
#hs=high score,   ihs=index high score   ,   shs=second high score     ,    ishs=number student high score   ,    shsn=student high score number 
